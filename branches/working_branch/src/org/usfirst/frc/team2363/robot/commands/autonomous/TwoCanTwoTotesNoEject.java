 ...
 *
 */
public class TwoCanTwoTotesNoEject extends CommandGroup {
    
    public  TwoCanTwoTotesNoEject() {
    	...
    	addSequential(new DrivePowerStraightAtTote(0.55, 25));
...
//    	addSequential(new DriveStraightAtSpeed(36, 78));
    	addSequential(new TurnToAngle(90, 0.68));
    	addSequential(new DriveToDistanceCommand(0.6, 70));
